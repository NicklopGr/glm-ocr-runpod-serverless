...
MODEL_REVISION="${MODEL_REVISION:-677c6baa60442a451f8a8c7eabdfab32d9801a0b}"
...
export LIMIT_MM_PER_PROMPT SPECULATIVE_CONFIG MM_PROCESSOR_KWARGS VLLM_HEALTH_TIMEOUT
